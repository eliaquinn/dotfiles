...
avante.setup({
	...
	minimax = {
		-- Herda do Claude já que MiniMax usa API compatível com Anthropic
		__inherited_from = "claude",
		-- Endpoint para usuários internacionais (use api.minimaxi.com se estiver na China)
		endpoint = "https://api.minimax.io/anthropic/v1/messages",
		model = "MiniMax-M2.1",
		api_key_name = "MINIMAX_API_KEY",
		timeout = 30000, -- Timeout em ms
		context_window = 200000, -- MiniMax M2.1 suporta ~200K+ tokens

		-- Parâmetros extras na requisição
		extra_request_body = {
			max_tokens = 8192,
			temperature = 0.2,
			top_p = 0.95,
			-- MiniMax recomenda estes parâmetros para melhor performance
		},
	},
	-- ============================================
